        ...
        await authState.keys.transaction(async () => {
            ...
            if (isGroupOrStatus && !isRetryResend) {
                ...
                if (!participant) {
                    ...
                    const selectedReportingMessage = Array.isArray(patchedForReporting)
                        ? patchedForReporting.find(item => item.recipientJid === jid) || patchedForReporting[0]
                        : patchedForReporting;
                    reportingMessage = patchMessageRequiresBeforeSending(selectedReportingMessage);
                }
                if (!isRetryResend) {
            ...
            if (isRetryResend) {
                ...
                const messageToEncrypt = patchMessageRequiresBeforeSending(messageToSend);
                const encodedMessageToSend = isMe
                    ...
                    : encodeWAMessage(messageToEncrypt);
